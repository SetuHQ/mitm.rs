...
pub fn read_cert(cert: String) -> Result<X509, ErrorStack> {
    return X509::from_pem(cert.as_bytes());
}

pub fn read_pkey(pkey: String) -> Result<PKey<Private>, ErrorStack> {
    return PKey::private_key_from_pem(pkey.as_bytes());
}
