...
mod tests {
  ...
  fn watch() {
    ...
    mock.enter(|cx, _| {
      let (tx, rx) = channel();
      let fut = TestMe { draining: false, finished: false, poll_cnt: 0 };
  ...
  fn watch_clones() {
    ...
    mock.enter(|cx, _| {
      ...
      let fut1 = TestMe { draining: false, finished: false, poll_cnt: 0 };
      let fut2 = TestMe { draining: false, finished: false, poll_cnt: 0 };
